  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-14 space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div className="p-6 rounded-3xl bg-card border border-line shadow-2xs">
          <div className="w-10 h-10 rounded-xl bg-[#16A765]/10 text-[#16A765] flex items-center justify-center mb-3">
            <ShieldCheck className="w-5 h-5" />
          </div>
          <h3 className="font-bold text-base text-ink">Zero-Telemetry</h3>
        ...
        <div className="p-6 rounded-3xl bg-card border border-line shadow-2xs">
          ...
          <h3 className="font-bold text-base text-ink">Modern Web &amp; PWAs</h3>
          <p className="text-xs text-mut mt-1.5 leading-relaxed">
        ...
        <div className="p-6 rounded-3xl bg-card border border-line shadow-2xs">
          ...
          <h3 className="font-bold text-base text-ink">Direct APK Downloads</h3>
          <p className="text-xs text-mut mt-1.5 leading-relaxed">
