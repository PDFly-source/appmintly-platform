  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="mb-8 sm:mb-12 max-w-2xl">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-card border border-line text-xs font-bold text-ink mb-3">
        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <Link
              ...
              className="group relative flex flex-col justify-between p-6 rounded-3xl bg-card border border-line hover:border-ink/40 hover:shadow-md transition-all duration-300"
            >
              <div>
                {/* Category Icon Badge */}
                <div
                ...
                <div className="flex items-center justify-between gap-2">
                  <h3 className="text-lg font-black text-ink group-hover:text-[#1976F3] transition-colors">
                    {cat.name}
                  </h3>
                  <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-page text-mut border border-line">
              ...
              <div className="mt-6 pt-4 border-t border-line/60 flex items-center justify-between text-xs font-bold text-ink">
